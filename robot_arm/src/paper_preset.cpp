...
std::vector<PaperPreset> createDefaultPaperPresets()
{
    ...
    smooth.albedoTexturePath = "../assets/papers/smooth_paper.png";
    ...
    rough.albedoTexturePath = "../assets/papers/rough_paper.png";
    ...
    recycled.albedoTexturePath = "../assets/papers/recycled_paper.png";
